...
public class CameraActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener {
    ...
    public void onCameraViewStarted(int width, int height) {
        ...
        if (this.myBitmap == null) {
            this.myBitmap = Bitmap.createBitmap((int)this.usedMat.cols(), (int)this.usedMat.rows(), (Bitmap.Config)Bitmap.Config.ARGB_8888);
        }
    }
    ...
    private class AsyncOcrTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            try {
                ...
                Log.e(TAG,"temp ::: "+temp);
                temp = CMyTessTwo.recognize(bitmap, 0, 0, w, h).replaceAll("[^-0123456789.]+", "");
